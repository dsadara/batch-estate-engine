...
public class JsonDeserializerTest {
    ...
    static void beforeAll() throws Exception {
        ...
        realEstateDataDtos = jsonDeserializer.jsonNodeToPOJO(jsonNodeSample);
    }
    ...
    void stringToJsonNode_Success() throws Exception {
        //given
        //when
        when(objectMapper.readTree(rawJsonSample).path(anyString()).path(anyString()).path(anyString()).findValue(anyString())).thenReturn(jsonNodeSample);
        //then
    ...
    void jsonNodeToPOJO_Success() throws Exception {
        //given
        //when
        when(objectMapper.readerFor(any(TypeReference.class)).readValue(any(JsonNode.class))).thenReturn(realEstateDataDtos);
        //then
        assertEquals(realEstateDataDtos, jsonDeserializer.jsonNodeToPOJO(jsonNodeSample));
    }
